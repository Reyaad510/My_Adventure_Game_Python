...
class Character:
    def __init__(self, name, description, maxhealth, health, attack, mp):
        self.name = name
...
class Hero(Character):
    def __init__(self, name, description, maxhealth, health, attack, mp, skills, ultimate, startRoom=None):
        super().__init__(name, description, maxhealth, health, attack, mp)
        self.skills = skills
...
class Villain(Character):
    def __init__(self, name, description, maxhealth, health, attack, mp, skills, ultimate, laugh):
        super().__init__(name, description, maxhealth, health, attack, mp)
        self.skills = skills
        self.ultimate = ultimate
        self.laugh = laugh
...
heroes = {
    'knight': Hero(
        'Sir Steiner', 'Protector of the Queen Brahman and Princess Garnet of Alexandria, Sir Steiner has sworn his life to them.', 100, 100, 10, 10, ['SwordSlash', 'FireStrike'], 'Knights of The Round Table'),

    'mage': Hero(
        'Vivi', 'A young mage that lives in Alexandria with his grandfather. He is humble, but his training in magic makes him a deadly opponent', 100, 100, 10, 10, ['Fire', 'Ice'], 'Meteor'),
